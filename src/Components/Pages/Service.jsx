...
import serviceL1 from '/src/assets/serviceL1.png'
import serviceL2 from '/src/assets/serviceL2.png'
import serviceL3 from '/src/assets/serviceL3.png'
  ...
  return (
    ...
    <Containar>
     <div className="py-2.5">
       <Image imgsrc={ServicLogo} className={"m-auto"}/>
     ...
     <div className="py-24">
      <Flex className={"justify-between gap-x-7"}>
        ...
        <div className="bg-[#EBF7E9] p-10  leading-7 rounded-2xl text-center h-[400px] w-1/3">
          <Image imgsrc={serviceL1} className={"m-auto"}/>
        ...
        <div className="bg-[#D8EAFF] p-10  leading-7 rounded-2xl text-center h-[400px] w-1/3">
          <Image imgsrc={serviceL2} className={"m-auto"}/>
        ...
        <div className="bg-[#FBF1EC] p-10  leading-7 rounded-2xl text-center h-[400px] w-1/3">
          <Image imgsrc={serviceL3} className={"m-auto"}/>
